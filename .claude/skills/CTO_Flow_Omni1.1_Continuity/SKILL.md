...
### A child and money in one prompt — in the picture OR in the words (2026-09-25/26)

Measured on «ตาชั่งของเสี่ย» ACT1/ACT2 at 720p, 12 credits a deleted take; `pull` afterwards said
"card not found" every time (deleted, not slow).

| shot | who is in frame | money | result |
|---|---|---|---|
| S7, S19 (ACT1) | grandmother + the 11-year-old | pastel prop notes in frame | deleted |
| S7, S19 retry | same | notes moved into a pouch, framing still said "over the notes" | deleted |
| S7 fix, S19 solo | same / grandmother alone | the words gone from the prompt | **kept** |
| S30 ×3 | grandmother + the 11-year-old (school uniform, then home clothes) | notes, then a closed pouch + the "no banknotes" block | deleted |
| S30 v2.3 | grandmother alone | none | **kept**, first try |
| S25 ×2 | villain + grandmother + onlooker (adults) | line "หลอกใช้ลูกข้าให้เอาเงินมาให้" | deleted |
| S25 solo | villain alone | same line | **deleted** |
| S25 v2.5 | villain alone | line without the child + money clause | **kept**, first try |
| S24 | schoolboy + father | line "เงินค่าข้าวของผมเอง … ไม่ใช่เงินพ่อสักบาท" | kept |
| S29 | the 11-year-old + grandmother | none | kept |

**The rule that fits every row:** a child and money together in one prompt is deleted — whether the
child is in frame or only in a line of dialogue ("tricked my kid into bringing money"), and whether the
money is on screen or only said. A child's own line about his own money (S24) survived, so this is a
default, not a law. The cheap fix that worked every time was the same: take the child or the money out
of that one shot (a solo shot, or cut the clause), not a softer description of the same thing.

**Not explained yet:** S50, two adult men and a stack of prop notes, was deleted; with the notes swapped
for a sealed envelope it was deleted again; as a solo shot of one man holding the envelope it was kept.
No child, no money on screen by the second take. Treat "two people + a humiliating money handover" as
suspect and go solo early.
