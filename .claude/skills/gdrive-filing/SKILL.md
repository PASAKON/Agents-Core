...
│   └── เรื่องบัญชี/            ONE STORY = ONE FOLDER, named `เรื่อง<ชื่อเรื่อง>` —
│       │                      always the word เรื่อง first (CEO 2026-09-19, e.g.
│       │                      `เรื่องจุดจบของเจ้าหนี้นอกระบบ`). Renamed from `EP1 บัญชี`
│       │                      the same day; the id did not change.
