...
- 2026-09-25 [COSTLY] §2 — `pytest -q` added on top of pytest.ini's own `-q` makes pytest very quiet: no totals line, so a grep for "passed" finds nothing; run without the extra flag · evidence: this session's T2 review · status: promoted (rule in §2, 2026-09-25)
