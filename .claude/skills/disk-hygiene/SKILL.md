...
- 2026-09-23 [RULE] §Green — abandoned Work/ folders added to the Green list (via `workdir.py close --archive`, never a plain delete) · evidence: CEO ruling 2026-09-23 "นับเป็น Green ได้ ถ้าไม่ได้ทำต่อแล้วนานมากๆ หรือฉันลืม" · status: applied
