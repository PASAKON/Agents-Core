...
| `S2AJ-Render.MP4` | 20s | wall-POV locked master (S2N camera); v3: fur+maroon there at 0s, critic jumps in at 3s (right end), student 7s, four-way quarrel 10-16s, cobalt 16s (left end), hard cut to black 19-20s; row = Draft 5 1:52 (cobalt·student·fur·maroon·critic); camera + blocking only; Blender, 480 frames |
