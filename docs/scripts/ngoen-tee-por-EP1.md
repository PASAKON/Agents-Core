...
**ชื่อซีรีส์:** เงินที่พ่อตั้งใจหา
**Logline:** ลูกชายที่เพิ่งเรียนจบไม่รู้ว่าทุกบาททุกสตางค์ที่พ่อเคยส่งเรียนคือหนี้นอกระบบ — และพ่อก็ตั้งใจจะไม่มีวันบอก

**แก่นคุณธรรม:** ความรักของพ่อแม่บางทีก็มาในรูปของความเงียบ — การให้ที่แท้จริงไม่ใช่การให้แล้วพูด แต่คือการยอมรับราคาที่ต้องจ่ายโดยไม่ให้อีกฝ่ายรู้ตัว "บทเรียน" ที่คนดูต้องรู้สึกเอง: การกตัญญูไม่ใช่การใช้หนี้คืน แต่คือการใช้ชีวิตให้คุ้มกับสิ่งที่ถูกซ่อนไว้เพื่อเรา

**โลกของเรื่อง:** ตึกแถวแคบย่านเมืองเก่ากรุงเทพฯ ร้านก๋วยเตี๋ยวเล็กๆ ของครอบครัวอยู่ชั้นล่าง ที่พักอาศัยชั้นบน ถนนพลุกพล่านนอกร้านตลอดวัน ฤดูร้อน ปัจจุบัน ฐานะ: ชนชั้นแรงงานเมือง รายได้วันต่อวัน

**โทนภาพ:** อ้างอิงหนังไทยร่วมสมัยแนวเรียลลิสม์ แสงธรรมชาติ อุ่น อมเหลือง ฝุ่นควันลอยในแสง เลนส์ 35-50mm สีหม่น ไม่จัดจ้าน กล้องนิ่งมากกว่าไหว ให้ความรู้สึกสารคดี

**PREMISE ENGINE:**
- **ความลับ:** พ่อกู้เงินนอกระบบมาตั้งแต่ลูกชายเข้ามหาวิทยาลัยเมื่อ 4 ปีก่อน — ค่าเทอมทุกงวดที่ลูกเคยจ่ายคือเงินกู้ทั้งหมด ลูกไม่เคยรู้
- **นาฬิกา:** ดอกเบี้ยทบต้นรายวันของเจ้าหนี้ บวกค่ารักษาย่ารายเดือนที่พลาดไม่ได้แม้เดือนเดียว
- **พยาน:** ย่าประนอม นอนติดเตียงชั้นบน หูยังได้ยินทุกอย่างที่เกิดขึ้นชั้นล่างผ่านพื้นไม้ แต่พูดไม่ได้และบอกใครไม่ได้

---

## 2. Character bible

### @lung_somchai — สมชาย, 58
...
stooped shoulders, a soft round face with deep smile-lines and dark under-eye
circles, short greying black hair combed flat, sun-weathered olive skin,
wearing a faded pale-blue short-sleeve button shirt under a stained once-white
apron tied twice at the waist, sleeves rolled to the elbow, a thin plain gold
wedding band on his left hand, worn brown rubber sandals. Neutral expression,
looking straight at camera, head and shoulders, plain light grey background,
soft even frontal lighting, no shadows on the face, sharp focus, 4:5.
```
...
short neat black hair side-parted, smooth unlined face, light-brown skin,
wearing a slightly wrinkled white collared shirt tucked into black slacks,
sleeves rolled up past the forearm, a plain black digital watch on his left
wrist, a lanyard with a blank ID card around his neck. Neutral expression,
looking straight at camera, head and shoulders, plain light grey background,
soft even frontal lighting, no shadows on the face, sharp focus, 4:5.
```
...
### @grandma_pranom — ประนอม, 79

**ไทย:** ย่าของต้น นอนติดเตียงชั้นบนมาหลายปี พูดได้เพียงคำสั้นๆ ไม่ชัด ปมในใจ: อยากเตือนหลานแต่ร่างกายไม่เอื้ออำนวย ต้องการ: ให้ลูกหลานปลอดภัยก่อนตัวเองจะตาย กลัว: ตายไปโดยไม่ได้บอกความจริงกับใครเลย
...
silver-white hair cropped short and thinning at the temples, deeply wrinkled
papery skin, sunken cheeks, cloudy but alert dark eyes, wearing a faded
floral-print cotton nightgown, a thin nasal cannula tube looped over her ears,
a small brass amulet on a string around her neck. Neutral expression, looking
...
**Reference-image prompt (free):**
```
Photorealistic portrait of a Thai man, 45 years old, medium build going soft
at the waist, slicked-back black hair with grey at the temples, clean-shaven
square jaw, tan skin, wearing a crisp short-sleeve dark-navy polo shirt
tucked into pressed grey trousers, a thick silver-link bracelet on his right
wrist, gold-rimmed sunglasses pushed up on his head. Neutral expression,
looking straight at camera, head and shoulders, plain light grey background,
soft even frontal lighting, no shadows on the face, sharp focus, 4:5.
```
...
### @noodle_shop — the location Ingredient

**ไทย:** ร้านก๋วยเตี๋ยวเล็กๆ ของครอบครัวหน้าตึกแถว โต๊ะไม้ 5 ตัวเก้าอี้พลาสติกไม่เข้าชุด รถเข็นสแตนเลสมีหม้อน้ำซุปควันลอย ประตูม้วนเปิดออกสู่ถนนพลุกพล่าน บันไดแคบด้านหลังขึ้นชั้นบน

**APPEARANCE LOCK:** A narrow Bangkok shophouse ground floor converted into a small noodle shop: five worn wooden tables with mismatched plastic stools, a stainless-steel soup cart with a steaming broth pot against the left wall, a chalkboard-style menu board with worn, illegible lettering taped to a pillar, an open roll-up shutter facing a busy street, a narrow wooden staircase at the back leading upstairs, strings of bare bulbs overhead, walls stained pale yellow with age.

**Reference-image prompt (free):**
```
Photorealistic wide establishing photo of a narrow Bangkok shophouse ground
floor converted into a small noodle shop: five worn wooden tables with
mismatched plastic stools, a stainless-steel soup cart with a steaming broth
pot against the left wall, a chalkboard-style menu board with worn, illegible
lettering taped to a pillar, an open roll-up shutter facing a busy street, a
narrow wooden staircase at the back leading upstairs, strings of bare bulbs
overhead, walls stained pale yellow with age. Empty of people, even soft
daylight through the open shutter, sharp focus, no legible text anywhere,
4:5.
```
...
Medium shot, static camera with a slight handheld sway. A man in a stained
apron is shoved hard against a rough concrete wall at the side of the
shophouse, his body jolting against the brick, an arm from off-frame doing
the shoving. Side alley of a narrow Bangkok shophouse, just before dawn, no
one else visible. Near-total darkness lit only by a distant streetlamp, harsh
side shadow across his face. Contemporary Thai realist drama, shot on 35mm,
desaturated colour.
Ambient noise: impact thud, distant late-night traffic hum. No music.
```
...
Close-up, static camera at a low angle. The man slides down the wall to a
crouch, breathing hard, as a folded envelope drops out of frame and lands in
a shallow puddle beside his feet. Same alley beside the shophouse, just
before dawn. Single distant streetlamp, deep shadow, wet pavement reflecting
the light. Contemporary Thai realist drama, shot on 35mm, desaturated colour.
Ambient noise: envelope hitting wet pavement, retreating footsteps fading
out. No music.
```
...
man's hands ladle hot broth from a steaming pot into a ceramic bowl. Behind
the counter of the noodle shop, mid-morning. Warm daylight, steam catching
the light. Contemporary Thai realist drama, shot on 35mm, muted colour.
Ambient noise: ladle scraping metal, steam hissing. No music.
```
...
board, sweat visible on his brow, eyes fixed on the blade. Behind the counter
of the noodle shop, mid-morning. Warm daylight, wok steam drifting through
frame. Contemporary Thai realist drama, shot on 35mm, muted colour.
Ambient noise: knife tapping the board, wok hissing. No music.
```
...
dining area without looking up from his work, one hand still stirring a pot.
Behind the counter of the noodle shop, mid-morning. Warm daylight. Contemporary
Thai realist drama, shot on 35mm, muted colour.
@lung_somchai speaks in Thai. He says, in Thai: "ต้น เก็บโต๊ะสองทีนึง" brisk tone.
Ambient noise: dish clatter, street murmur through the shutter. No music.
```
...
speaking to a younger man stacking bowls beside him. Behind the counter of
the noodle shop, mid-morning. Warm daylight, steam rising between them.
Contemporary Thai realist drama, shot on 35mm, muted colour.
@lung_somchai speaks in Thai. He says, in Thai: "อย่าลืมเติมน้ำซุปด้วยนะ" routine tone.
Ambient noise: broth pouring, kitchen clatter. No music.
```
...
in front of the open shutter of the shop, morning crowd moving along the
narrow street. Street outside the shophouse, mid-morning. Bright open
daylight. Contemporary Thai realist drama, shot on 35mm, muted colour.
Ambient noise: motorbike engines, a vendor cart bell. No music.
```
...
regular customer, nodding at something the customer just said, a small
pleased smile crossing his tired face. Inside the noodle shop, late morning.
Warm daylight, soft shadow. Contemporary Thai realist drama, shot on 35mm,
muted colour.
@lung_somchai speaks in Thai. He says, in Thai: "ขอบคุณครับ แวะมาเรื่อยๆนะ" pleased but weary tone.
Ambient noise: bowl set on wood, background chatter. No music.
```
...
rag, his eyes flicking toward a faint glow from his apron pocket. Inside the
noodle shop, late morning. Warm daylight. Contemporary Thai realist drama,
shot on 35mm, muted colour.
Ambient noise: rag against wood, a muffled phone buzz. No music.
```
...
the phone screen cupped in his hand, his jaw tightening, eyes lowering.
Behind the counter of the noodle shop, late morning. Warm daylight dimming
slightly as he turns from the window. Contemporary Thai realist drama, shot
on 35mm, muted colour.
Ambient noise: shop ambience thinning under him. No music.
```
...
son's face across the room, then lowers his eyes back to his work without a
word. Behind the counter of the noodle shop, late morning. Warm daylight, wok
steam rising past his face. Contemporary Thai realist drama, shot on 35mm,
muted colour.
Ambient noise: wok sizzle continuing under him. No music.
```
...
of the counter without speaking, steam drifting in the space between them.
Inside the noodle shop, late morning. Warm daylight through the shutter.
Contemporary Thai realist drama, shot on 35mm, muted colour.
Ambient noise: steam hiss, distant traffic. No music.
```
...
wooden staircase carrying a covered bowl of rice porridge on a small tray.
Inside a narrow stairwell of a shophouse, early afternoon. Dim light from a
single bulb above. Contemporary Thai realist drama, shot on 35mm, muted
colour.
Ambient noise: footsteps on creaking wood, faint clinking bowl. No music.
```
...
gently toward an elderly woman propped against pillows. A small upstairs
bedroom above the shop, early afternoon. Soft light through a thin curtain.
Contemporary Thai realist drama, shot on 35mm, muted colour.
@nong_daeng speaks in Thai. He says, in Thai: "ย่า กินข้าวก่อนนะครับ" soft tone.
Ambient noise: spoon against ceramic bowl. No music.
```
...
alert but unable to form clear words, her lips parting slightly. Upstairs
bedroom, early afternoon. Soft filtered light. Contemporary Thai realist
drama, shot on 35mm, muted colour.
Ambient noise: ceiling fan creaking. No music.
```
...
trembling around a single syllable, her hand twitching against the bedsheet.
Upstairs bedroom, early afternoon. Soft filtered light. Contemporary Thai
realist drama, shot on 35mm, muted colour.
@grandma_pranom speaks in Thai. She says, in Thai: "...ต้น..." trembling, straining tone.
Ambient noise: fan creak, faint shop noise rising from below. No music.
```
...
the corner of an elderly woman's mouth with a cloth. Upstairs bedroom, early
afternoon. Soft filtered light. Contemporary Thai realist drama, shot on
35mm, muted colour.
@nong_daeng speaks in Thai. He says, in Thai: "อร่อยไหมครับย่า" tender tone.
Ambient noise: spoon set down, quiet breathing. No music.
```
...
drifts downward, fixed on a narrow gap in the wooden floor beneath her bed.
Upstairs bedroom, early afternoon. Soft filtered light, a sliver of light
rising through the floor gap. Contemporary Thai realist drama, shot on 35mm,
muted colour.
Ambient noise: faint clatter and voices rising from the shop below. No music.
```
...
cash drawer open in front of him, sorting bills between his fingers. Back
counter of the noodle shop, afternoon lull. Soft warm light, shop otherwise
empty. Contemporary Thai realist drama, shot on 35mm, muted colour.
Ambient noise: bills rustling, distant fan. No music.
```
...
distinct piles on the counter, one visibly larger than the other. Back
counter of the noodle shop, afternoon lull. Soft warm light. Contemporary
Thai realist drama, shot on 35mm, muted colour.
Ambient noise: bills being counted and stacked. No music.
```
...
counter, watching curiously as the older man counts money. Back counter of
the noodle shop, afternoon lull. Soft warm light. Contemporary Thai realist
drama, shot on 35mm, muted colour.
@nong_daeng speaks in Thai. He says, in Thai: "พ่อนับเงินอยู่เหรอ" casual tone.
Ambient noise: ceiling fan whirring. No music.
```
...
them under a ledger book without looking up. Back counter of the noodle shop,
afternoon lull. Soft warm light. Contemporary Thai realist drama, shot on
35mm, muted colour.
@lung_somchai speaks in Thai. He says, in Thai: "เปล่า เช็คยอดเฉยๆ" deflecting, light tone.
Ambient noise: bills stacked quickly, paper sliding. No music.
```
...
the larger stack of bills into a plain envelope. Back counter of the noodle
shop, afternoon lull. Soft warm light. Contemporary Thai realist drama, shot
on 35mm, muted colour.
Ambient noise: paper folding. No music.
```
...
with his thumb, setting it down deliberately on the counter. Back counter of
the noodle shop, afternoon lull. Soft warm light. Contemporary Thai realist
drama, shot on 35mm, muted colour.
Ambient noise: envelope crease, quiet room tone. No music.
```
...
the stairs, unnoticed, his eyes fixed on the envelope on the counter below.
Stairwell view into the noodle shop's back counter, afternoon lull. Soft warm
light. Contemporary Thai realist drama, shot on 35mm, muted colour.
Ambient noise: distant street traffic. No music.
```
...
high shelf and closes the lid softly, exhaling. Back counter of the noodle
shop, afternoon lull. Soft warm light catching the edge of the tin box. Contemporary
Thai realist drama, shot on 35mm, muted colour.
Ambient noise: tin lid closing softly. No music.
```
...
between full tables, ladling bowls and clearing dishes in a crowded room.
Inside the noodle shop, early evening. Warm bulb light, the shutter open to a
dark street. Contemporary Thai realist drama, shot on 35mm, muted colour.
@lung_somchai speaks in Thai. He says, in Thai: "ลูกชิ้นพิเศษโต๊ะห้า" busy, routine tone.
Ambient noise: full dinner-rush chatter and clatter. No music.
```
...
shutter into the crowded shop, scanning the room calmly, unhurried. Entrance
of the noodle shop, early evening. Warm bulb light against the dark street
behind him. Contemporary Thai realist drama, shot on 35mm, muted colour.
Ambient noise: shutter chain, street noise briefly louder as he enters. No music.
```
...
an easy, public smile, gesturing at an empty table. Inside the noodle shop,
early evening. Warm bulb light. Contemporary Thai realist drama, shot on
35mm, muted colour.
@lender_cherd speaks in Thai. He says, in Thai: "สวัสดีครับพี่ชาย มาทานก๋วยเตี๋ยวหน่อย" friendly, unsettling tone.
Ambient noise: dinner-rush ambience continuing. No music.
```
...
recovers it, wiping his hands slowly on his apron. Inside the noodle shop,
early evening. Warm bulb light. Contemporary Thai realist drama, shot on
35mm, muted colour.
Ambient noise: shop ambience continuing under him. No music.
```
...
table while already turning back toward the kitchen. Inside the noodle shop,
early evening. Warm bulb light. Contemporary Thai realist drama, shot on
35mm, muted colour.
@lung_somchai speaks in Thai. He says, in Thai: "เชิญนั่งก่อนครับ เดี๋ยวผมมา" strained, polite tone.
Ambient noise: bowls clinking nearby. No music.
```
...
room at his father and the well-dressed customer, then answers a call from
another table without looking away. Inside the noodle shop, early evening.
Warm bulb light. Contemporary Thai realist drama, shot on 35mm, muted colour.
@nong_daeng speaks in Thai. He says, in Thai: "ครับ เดี๋ยวเอาไปให้ครับ" distracted, polite tone.
Ambient noise: kitchen noise, his own breath held. No music.
```
...
door into a narrow alley, the door clicking shut behind them. Back alley
behind the shophouse, early evening. Single bare bulb overhead, deep shadow.
Contemporary Thai realist drama, shot on 35mm, desaturated colour.
Ambient noise: door latch, alley ambience, distant insects. No music.
```
...
his posture relaxed, one hand adjusting his cuff. Back alley behind the
shophouse, early evening. Single bare bulb overhead. Contemporary Thai
realist drama, shot on 35mm, desaturated colour.
@lender_cherd speaks in Thai. He says, in Thai: "งวดนี้พี่ช้าไปสามวันแล้วนะครับ" calm, menacing tone.
Ambient noise: distant traffic, insects. No music.
```
...
open in a placating gesture. Back alley behind the shophouse, early evening.
Single bare bulb overhead. Contemporary Thai realist drama, shot on 35mm,
desaturated colour.
@lung_somchai speaks in Thai. He says, in Thai: "พรุ่งนี้ผมหาให้ครบแน่นอน" pleading, controlled tone.
...
hand grips the front of a man's shirt and shoves him back against the alley
wall in one motion. Back alley behind the shophouse, early evening. Single
bare bulb overhead, hard shadow. Contemporary Thai realist drama, shot on
35mm, desaturated colour.
Ambient noise: body against wall, sharp intake of breath. No music.
```
...
single bare bulb, watching something out of frame with widening eyes. Back
alley doorway behind the shophouse, early evening. Harsh single bulb light.
Contemporary Thai realist drama, shot on 35mm, desaturated colour.
Ambient noise: bulb hum, muffled voices nearby. No music.
```
...
just released, his voice unchanged in volume, almost gentle. Back alley
behind the shophouse, early evening. Single bare bulb overhead. Contemporary
Thai realist drama, shot on 35mm, desaturated colour.
@lender_cherd speaks in Thai. He says, in Thai: "สี่ปีแล้วนะพี่ ดอกมันไม่รอใคร" pleasant, threatening tone.
Ambient noise: same low alley ambience. No music.
```
...
counting something backward in his head, barely audible under his breath.
Back alley doorway behind the shophouse, early evening. Harsh single bulb
light. Contemporary Thai realist drama, shot on 35mm, desaturated colour.
@nong_daeng speaks in Thai. He says, in Thai: "...สี่ปี... ค่าเทอมผม..." trembling whisper tone.
Ambient noise: his own breath, distant traffic. No music.
```
...
alley wall to steady himself, breathing hard, eyes unfocused. Back alley
behind the shophouse, early evening. Harsh single bulb light. Contemporary
Thai realist drama, shot on 35mm, desaturated colour.
Ambient noise: heavy breathing, distant traffic. No music.
```
...
into the bright, noisy dining room, his expression unreadable as the crowd
blurs past him. Entrance from the alley into the noodle shop, early evening.
Warm bulb light against the dark doorway behind him. Contemporary Thai
realist drama, shot on 35mm, muted colour.
Ambient noise: dinner-rush noise swelling back in around him. No music.
```
...
closing, stirring a small pot, shoulders sagging. Inside the noodle shop,
late night, chairs stacked on the tables around him. Single overhead bulb,
dark street visible through the shutter. Contemporary Thai realist drama,
shot on 35mm, muted colour.
@lung_somchai speaks in Thai. He says, in Thai: "เหนื่อยจัง" exhausted, to no one tone.
Ambient noise: wok simmer, empty street outside. No music.
```
...
staircase into the shop, an envelope held in one hand, his jaw set. Inside
the noodle shop's stairwell, late night. Single overhead bulb. Contemporary
Thai realist drama, shot on 35mm, muted colour.
Ambient noise: footsteps on wooden stairs. No music.
```
...
counter in front of a man still facing the wok. Counter of the noodle shop,
late night. Single overhead bulb. Contemporary Thai realist drama, shot on
35mm, muted colour.
@nong_daeng speaks in Thai. He says, in Thai: "พ่อ ผมไม่เอาเงินนี้" firm, guilty tone.
Ambient noise: envelope set on wood, wok simmer. No music.
```
...
the pot without turning around. Counter of the noodle shop, late night.
Single overhead bulb. Contemporary Thai realist drama, shot on 35mm, muted
colour.
Ambient noise: wok simmer continuing. No music.
```
...
his voice flat and final. Counter of the noodle shop, late night. Single
overhead bulb. Contemporary Thai realist drama, shot on 35mm, muted colour.
@lung_somchai speaks in Thai. He says, in Thai: "เอาไปเถอะ" quiet, final tone.
Ambient noise: simmer continuing under him. No music.
```
...
one hand gripping the edge of the counter. Counter of the noodle shop, late
night. Single overhead bulb. Contemporary Thai realist drama, shot on 35mm,
muted colour.
@nong_daeng speaks in Thai. He says, in Thai: "ผมรู้เรื่องเชิดแล้ว" breaking control tone.
Ambient noise: near silence under his voice. No music.
```
...
curling around his frozen fingers. Counter of the noodle shop, late night.
Single overhead bulb. Contemporary Thai realist drama, shot on 35mm, muted
colour.
Ambient noise: steam rising, a distant dog barking. No music.
```
...
son directly, holding his gaze without speaking. Counter of the noodle shop,
late night. Single overhead bulb. Contemporary Thai realist drama, shot on
35mm, muted colour.
Ambient noise: simmer fading, street gone quiet. No music.
```
...
son's open hands, closing the younger man's fingers over it with his own.
...
folded hands a moment longer before releasing them. Counter of the noodle
shop, late night. Single overhead bulb. Contemporary Thai realist drama,
shot on 35mm, muted colour.
@lung_somchai speaks in Thai. He says, in Thai: "ไม่ต้องรู้ว่ามันมาจากไหน แค่ใช้มันให้คุ้ม" tender, final tone.
Ambient noise: simmer under them. No music.
```
...
fresh handful of noodles into a pot of boiling water, steam rising to
envelop his face, expression composed. Wok station of the noodle shop, late
night. Single overhead bulb, thick steam. Contemporary Thai realist drama,
shot on 35mm, muted colour.
Ambient noise: noodles dropping into boiling water. No music.
```
...
now held in both hands, watching his father's back at the wok without moving.
Counter of the noodle shop, late night. Single overhead bulb. Contemporary
Thai realist drama, shot on 35mm, muted colour.
Ambient noise: distant simmer, street gone quiet. No music.
```
...
around, speaking over his shoulder in an ordinary, everyday tone. Wok station
of the noodle shop, late night. Single overhead bulb. Contemporary Thai
realist drama, shot on 35mm, muted colour.
@lung_somchai speaks in Thai. He says, in Thai: "กินก่อนไปสมัครงานนะ" gentle, ordinary tone.
Ambient noise: ladle in broth. No music.
```
...
**Cliffhanger shape: REVELATION.** Tag EP2's cliffhanger with a different
shape (REVERSAL, DEADLINE, or INTRUSION) — a season that ends every episode
on a REVELATION trains the audience to expect one, and the reveals stop
carrying weight by episode 5.
...
2. **On-screen text risk — the shop's menu board.** The `@noodle_shop`
   ...
   unintentional legible text in an Ingredient reference image will render
   garbled in every shot that reuses it. Fix: reworded to "a chalkboard-style
...
4. **Character visible without an Ingredient tag — the attacker in the HOOK.**
   ...
   as a specific person would still require a consistency Ingredient, or would
   drift on regeneration. Fix: the attacker is written entirely off-frame — an
...
5. **Misattributed dialogue caught during drafting (shot 11).** An early draft
   ...
   background customers have no Ingredient/handle and cannot carry dialogue in
   this format, the fix keeps the beat but rewrites it as a line the father
   himself would say in response ("ขอบคุณครับ แวะมาเรื่อยๆนะ" — thanking a regular
