...
| S18 | Dupe rich, the interview — then alone at a white wall, hammer. | 11s (target 25s) | 🔴 **take 1 FIRED, rendering** — asset `76fc65dc-724c-40b3-b8d5-de50b1f7ade7`. loc_mansion, prop_cart, char_cleaner_rich, prop_camera_rig — 4/4 clean after clearing first-use eligibility scans on 3 new Elements (pending → cleared, not terminal). Unlimited $0, 720p, 16:9. **⚠️ Fired BEFORE CTO's duration hard-gate existed — carries 2 short lines of dialogue ("How did you know?" / "I dropped a painting."), landed at 11s against a 25s target. May be cut off — check on collection whether both lines survive** |
