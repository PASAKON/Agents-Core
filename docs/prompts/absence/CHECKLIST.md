...
| S18 | Dupe rich, the interview — then alone at a white wall, hammer. | 11s | 🔴 **take 1 FIRED, rendering** — asset `76fc65dc-724c-40b3-b8d5-de50b1f7ade7`. loc_mansion, prop_cart, char_cleaner_rich, prop_camera_rig — 4/4 clean after clearing first-use eligibility scans on 3 new Elements (pending → cleared, not terminal). Unlimited $0, 720p, 16:9. Not yet collected |
