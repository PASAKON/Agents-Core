commit cc16c25180d217d323c2c2b402839778a75df908
Author: golfmaichai1 <pass.gob1@gmail.com>
Date:   Sat Sep 19 15:39:32 2026 +0700

    banchi shoot: Act1 shot-06/24, Act2 shot-35/36 landed; replay script
    
    Act1 shot-06 (8s) and shot-24 (10s) downloaded to ~/Desktop/banchi-ACT1-v2/.
    Act2 shot-35 (6s) and shot-36 (8s) downloaded to ~/Desktop/banchi-ACT2/.
    Every clip verified against its own prompt text (REF_0/REF_1 opening line)
    before download, not by thumbnail/title/position.
    
    Holding before shot-37 to 46: shot-36's live @lender_cherd voice binding
    reads "Umbriel", not "algieba" as the sheet/brief claims after the audit.
    Flagged to CTO for a CEO ear-check before shooting the rest of Act2, since
    cherd speaks in most remaining shots and a rebind afterward would waste
    ~10 x 12 credits.
    
    downloads-s1.tsv logs shot->filename per shot, appended immediately per
    shot rather than batched. scripts/browser/banchi-flow-shoot.js records the
    working method and the traps hit this run (degraded-tab clicks, main-grid
    single-click not navigating, chip-attach bimodality, voice-belongs-to-
    character).
    
    Co-Authored-By: Claude Sonnet 5 <noreply@anthropic.com>
    Claude-Session: https://claude.ai/code/session_01U2nhHWAYPbCmmw3Wovif3V

diff --git a/downloads-s1.tsv b/downloads-s1.tsv
new file mode 100644
index 00000000..43e477a8
--- /dev/null
+++ b/downloads-s1.tsv
@@ -0,0 +1,5 @@
+1	Man_talking_against_shophouse_wall_20260919141229.mp4
+shot-06	Man_counting_money_in_bedroom_20260919151307.mp4
+shot-24	Shopkeeper_counting_costs_in_noo…_20260919152800.mp4
+shot-35	Men_working_in_noodle_shop_20260919153654.mp4
+shot-36	Man_speaking_in_noodle_shop_20260919153534.mp4
diff --git a/scripts/browser/banchi-flow-shoot.js b/scripts/browser/banchi-flow-shoot.js
new file mode 100644
index 00000000..1865ccca
--- /dev/null
+++ b/scripts/browser/banchi-flow-shoot.js
@@ -0,0 +1,128 @@
