...
| S4B | 1 | `fe43795d-4fe7-4bda-b693-27e031949e23` | 8/8, 0 errors | Seedance 2.5 / 16:9 / 720p / 20s / High / Sound On / Unlimited ON | Staged during S4's render. Real-clipboard paste verified exact: 18,519 normalized chars, first/last 80 identical, all 8 mentions resolved to real UUIDs. Reference strip: 1 of 8 flagged, cleared via triangle-click, re-verified clean. Generate button confirmed `UNLIMITED / ~~140~~ / 0`. Fired clean, "Generation started" toast, credits 1,918 unchanged. Rendering. |
