...
printf '\033]1;%s ⏳ เริ่ม session\007' "$TAB_TITLE"
...
# "🎯 <ROLE> #<sid> · ⏱ 0m" — honest, and already ticking; the agent replaces
# the goal at /session-open. Also starts the shared refresh daemon.
