...
FIX1_FOLDER_ID = "1WBk3uts8UaJQwBZuLwWjTFf6mcCMoidc"   # All Scene/Fix-1
...
def main() -> int:
    ...
    ap.add_argument("note", nargs="*", default=["Fix-1 wave upload"])
    ...
    res = upload(local, args.drive_name, FIX1_FOLDER_ID)
