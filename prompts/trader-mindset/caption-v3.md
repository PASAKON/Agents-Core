...
> **DRAFT v3 — NOT ACTIVE.** Generated by `scripts/tm_prompt_evolve.py` from v1 on 2026-06-14.
> Folded (reflected into this prompt): none. Promoted to validator (NOT in prompt): other×2.
