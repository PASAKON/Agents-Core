...
$argArray = @(Get-Content -Raw -Path 'C:\Users\UsEr\mooniex\worktrees\mooniex-agents__browser_operator__task-1755ef77\.launch\args.json' -Encoding UTF8 | ConvertFrom-Json)
& $claudeExe @argArray
