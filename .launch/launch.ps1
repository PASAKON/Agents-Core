...
$argArray = @(Get-Content -Raw -Path 'C:\Users\UsEr\mooniex\worktrees\mooniex-agents__browser_operator__task-5e0b9915\.launch\args.json' -Encoding UTF8 | ConvertFrom-Json)
& $claudeExe @argArray
