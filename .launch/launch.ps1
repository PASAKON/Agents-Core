...
$argArray = @(Get-Content -Raw -Path 'C:\Users\UsEr\mooniex\worktrees\mooniex-agents__browser_operator__task-c72d5ba5\.launch\args.json' -Encoding UTF8 | ConvertFrom-Json)
& $claudeExe @argArray
